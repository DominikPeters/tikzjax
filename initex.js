...
process.chdir(path.join(__dirname, 'web2js'));
...
library.setInput(
    '\n&latex\n' +
        ...
        '\\usepackage{tikz}\n' +
        '\\usetikzlibrary{arrows,arrows.meta,positioning,calc,shapes,shapes.geometric,shapes.arrows,fit,decorations.pathmorphing,decorations.markings,matrix,backgrounds,patterns}\n\n' +
